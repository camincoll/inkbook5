...
class StatusesControllerTest < ActionController::TestCase
  ...
  test "should render the new page wehn logged in" do
    sign_in users(:jason)
    get :new
    assert_response :success
  end
  ...
  test "should get edit will be redirected when not logged in" do
    get :edit, id: @status
    assert_response :redirect
    assert_redirected_to new_user_session_path
  end
  ...
  test "should update status should redirect when not logged in" do
  ...
  test "should not update status for the current user if it is empty" do
    sign_in users(:jason)
